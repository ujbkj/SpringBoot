...
import com.catering.common.core.constant.CacheConstants;
...
import com.catering.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered
{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain)
    {
        ...
        // 设置永久prtocken
        if (token.equals(Constants.PRTOCKEN)) {
            return chain.filter(exchange);
        }
