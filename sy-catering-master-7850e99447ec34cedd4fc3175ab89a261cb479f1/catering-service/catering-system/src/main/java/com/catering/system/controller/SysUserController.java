...
import com.catering.system.service.ISysPermissionService;
...
public class SysUserController extends BaseController
{
    ...
    @GetMapping("/queryEateryInterest/{eateryUid}")
    public R<String> queryEateryInterest(@PathVariable("eateryUid") String eateryUid)
    {
       return R.ok(userService.queryEateryInterest(eateryUid));
    }

    @GetMapping("/queryEateryUid/{phoneNumber}")
    public R<String> selectEateryUid(@PathVariable("phoneNumber") String phoneNumber){
        if(phoneNumber == null) {
            R.fail("手机号为空");
        }
        return R.ok(userService.selectEateryUid(phoneNumber));
    }
    ...
    @GetMapping("/queryPrintType/{eateryUid}")
    public R<Integer> queryPrintType(@PathVariable("eateryUid") String eateryUid){
        return R.ok(userService.queryPrintType(eateryUid));
    }

    @GetMapping("/queryEateryPhone/{eateryUid}")
    public R<String> queryEateryPhone(@PathVariable("eateryUid") String eateryUid){
        return R.ok(userService.queryEateryPhone(eateryUid));
    }
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user)
    {
        ...
        user.creationEateryUid(); // 创建餐饮店标识
